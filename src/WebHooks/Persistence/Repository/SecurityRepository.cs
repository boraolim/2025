...
using DbConstantsLocal = WebHooks.Domain.Constants.DbConstants;

namespace WebHooks.Persistence.Repository
{
    public class SecurityRepository : ISecurityRepository
    {
        ...
        public async Task<UserEntity> GetAccountByUserName(string userName)
        {
            ...
            return (!_userExist.Any()) ? null : _userExist.SingleOrDefault();
        }
